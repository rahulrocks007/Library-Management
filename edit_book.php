...
<body>
    <div class="edit-profile-container">
        <?php
			...
			$id=$_GET['ed'];
			$q= "SELECT books.bookpic,books.bookid,books.bookname,authors.authorid,authors.authorname,category.categoryid,category.categoryname,books.ISBN,books.price,quantity from  `books`join `authors` on authors.authorid=books.authorid join `category` on category.categoryid=books.categoryid where bookid=$id";
    ...
    <?php
        if(isset($_POST['submit']))
        {
            ...
            $q1="UPDATE books SET bookpic = '$pic',bookname='$bookname',authorid='$authorname',categoryid='$categoryname',ISBN='$ISBN',price='$price',quantity='$quantity' where bookid=".$id.";";
