        ...
        <div class="form">
            <div class="form-container">
                ...
                <form action="" id="loginform" method="post">
                    <input type="password" placeholder="Enter New Password" name="newpassword" id="update2" required>
                    <input type="password" placeholder="Confirm New Password" name="confirmpassword" id="update2" required>
